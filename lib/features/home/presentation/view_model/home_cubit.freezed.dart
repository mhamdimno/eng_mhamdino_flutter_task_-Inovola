...
mixin _$HomeState {
  ...
  int get currentPage =>
      throw _privateConstructorUsedError; // Current page number
...
// Current page number
  ...
  @override
  String toString() {
    return 'HomeState(isLoading: $isLoading, isLoadingList: $isLoadingList, homeModel: $homeModel, filter: $filter, errorMessage: $errorMessage, currentPage: $currentPage, hasReachedMax: $hasReachedMax)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, isLoadingList,
      homeModel, filter, errorMessage, currentPage, hasReachedMax);
...
abstract class _HomeState implements HomeState {
  factory _HomeState(
      ...
      final String? errorMessage,
      final int currentPage,
      final bool hasReachedMax}) = _$HomeStateImpl;
